            ...
            <div class="col-12 mt-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="jumbotron jumbotron-fluid" style="background-image: url('img/tes2.png');">
                            <div class="container">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 col-lg-3 mb-4">
                                    ...
                                    <div class="pt-3">
                                        <p class="mb-2"><a href="http://localhost/Salimah_CI/Detail_Produk" class="font-weight-bold text-primary">Flowers
                                                Structured Coat</a></p>
                                        <div class="clearfix">
            ...
            <div class="col-12 mt-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="jumbotron jumbotron-fluid " style="background-image: url('img/tes3.png');">
                            <div class="container">

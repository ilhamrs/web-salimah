...
<head>
    ...
    <!-- START: Page CSS-->
    <link rel="stylesheet" href="../dist/vendors/themify-icons/themify-icons.css">
...
<body id="main-container" class="default">
            ...
            <ul id="side-menu" class="sidebar-menu">
                <li class="dropdown active"><a href="#"><i class="icon-home mr-1"></i> Dashboard</a>
                    <ul>
                        ...
                        <li class="active"><a href="http://localhost/Salimah_CI/admin/list_produk"><i class="icon-bag"></i> List Produk</a>
                        </li>
    ...
    <main>
                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <a type="button" class="btn btn-primary" href="http://localhost/Salimah_CI/admin/tambah_produk">Tambah Produk</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table id="example" class="display table dataTable table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>2020/04/25</td>
                                            <td>
                                                <a href="http://localhost/Salimah_CI/admin/edit_produk" class="btn btn-lg btn-info mb-2">
                                                    <span class="icon-pencil mr-2 h6 mb-0"></span> Edit</a><br>
                                                <button class="btn btn-lg btn-danger mb-2" data-toggle="modal" data-target="#hapusProdukModal">
        ...
        <!-- Modal -->
        <div class="modal fade" id="hapusProdukModal" tabindex="-1" role="dialog" aria-labelledby="hapusProdukModal" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary">Hapus Produk</button>
                    </div>
                </div>
            </div>
        </div>

                        ...
                        <form action="post" class="row row-eq-height lockscreen  mt-5 mb-5">
                            ...
                            <div class="login-form col-12 col-sm-7">
                                ...
                                <div class="form-group mb-0">
                                    <button type="button" class="btn btn-primary btn-block mb-2" id="register">Tambah Admin</button>
                                </div>
                                <br>
                                <div class="mt-2"><a href="http://localhost/Salimah_CI/admin/list_akun_admin">Kembali</a></div>

...
<body id="main-container" class="default">
                ...
                <li class="dropdown active"><a href="#"><i class="icon-home mr-1"></i> Dashboard</a>
                    <ul>
                        ...
                        <li><a href="http://localhost/Salimah_CI/admin/list_akun_admin" style="color: white;"><i class="icon-people"></i> List Akun
                                Admin</a></li>
                        <li class="active"><a href="http://localhost/Salimah_CI/admin/list_pesanan"><i class="icon-basket-loaded"></i> List
                                Pesanan</a></li>
                                ...
                                <table id="example" class="display table dataTable table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>0001</td>
                                            <td>Udin </td>
                                            <td>Produk 1, Produk 2</td>
                                            <td>Rp 50.000,00</td>
                                            <td>2</td>
                                            <td>2011/07/25</td>
                                            <td>2021/07/25</td>
                                            <td>
                                                <span class="badge p-2 badge-success mb-1">Selesai</span>
                                            </td>
                                            <td>
                                                <a href="http://localhost/Salimah_CI/admin/detail_pesanan" class="btn btn-lg btn-info mb-2">
                                                    <span class="icon-info mr-2 h6 mb-0"></span> Detail</a>
                                        ...
                                        <tr>
                                            <td>0002</td>
                                            <td>Joko </td>
                                            <td>Produk 3, Produk 4</td>
                                            <td>Rp 100.000,00</td>
                                            <td>4</td>
                                            <td>2011/12/25</td>
                                            <td>2019/07/25</td>
                                            <td>
                                                <span class="badge p-2 badge-danger mb-1">Dibatalkan</span>
                                            </td>
                                            <td>
                                                <a href="http://localhost/Salimah_CI/admin/detail_pesanan" class="btn btn-lg btn-info mb-2">
                                                    <span class="icon-info mr-2 h6 mb-0"></span> Detail</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>2019/07/25</td>
                                            <td>
                                                <span class="badge p-2 badge-warning mb-1">Menunggu Pembayaran</span>
                                            </td>
                                            <td>
                                                <a href="http://localhost/Salimah_CI/admin/detail_pesanan" class="btn btn-lg btn-info mb-2">
                                                    <span class="icon-info mr-2 h6 mb-0"></span> Detail</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>2019/07/25</td>
                                            <td>
                                                <span class="badge p-2 badge-secondary mb-1">Dalam Proses</span>
                                            </td>
                                            <td>
                                                <a href="http://localhost/Salimah_CI/admin/detail_pesanan" class="btn btn-lg btn-info mb-2">
                                                    <span class="icon-info mr-2 h6 mb-0"></span> Detail</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>2019/07/25</td>
                                            <td>
                                                <span class="badge p-2 badge-info mb-1">Dalam Pengiriman</span>
                                            </td>
                                            <td>
                                                <a href="http://localhost/Salimah_CI/admin/detail_pesanan" class="btn btn-lg btn-info mb-2">
                                                    <span class="icon-info mr-2 h6 mb-0"></span> Detail</a>
    ...
    <!-- START: Page JS-->
    <script src="../dist/js/app.invoicelist.js"></script>
    <!-- END: Page JS-->

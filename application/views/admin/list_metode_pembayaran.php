...
<head>
    <meta charset="UTF-8">
    <title>List Metode Pembayaran</title>
...
<body id="main-container" class="default">
            ...
            <ul id="side-menu" class="sidebar-menu">
                <li class="dropdown active"><a href="#"><i class="icon-home mr-1"></i> Dashboard</a>
                    <ul>
                        ...
                        <li><a href="http://localhost/Salimah_CI/admin/list_akun_admin" style="color: white;"><i class="icon-people"></i> List Akun
                                Admin</a></li>
                        <li><a href="http://localhost/Salimah_CI/admin/list_pesanan" style="color: white;"><i class="icon-basket-loaded"></i> List
                                Pesanan</a></li>
                        <li class="active"><a href="http://localhost/Salimah_CI/admin/list_metode_pembayaran"><i class="icon-credit-card"></i>
    ...
    <main>
                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <a href="http://localhost/Salimah_CI/admin/tambah_metode_pembayaran" class="btn btn-primary">Tambah Metode Pembayaran</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table id="example" class="display table dataTable table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Bank Apa Aja</td>
                                            <td>1234567890</td>
                                            <td>Salimah Bandung</td>
                                            <td>Aktif</td>
                                            <td>2011/07/25</td>
                                            <td>2021/07/25</td>
                                            <td>
                                                <a href="http://localhost/Salimah_CI/admin/edit_metode_pembayaran" class="btn btn-lg btn-info mb-2">
                                                    <span class="icon-pencil mr-2 h6 mb-0"></span> Edit</a><br>
                                                <button class="btn btn-lg btn-danger mb-2" data-toggle="modal" data-target="#hapusMetodePembayaranModal">
                                                    <span class="icon-trash mr-2 h6 mb-0"></span> Hapus
                                                </button>
                                            </td>
                                        </tr>
                                        <tr>
        ...
        <!-- Modal -->
        <div class="modal fade" id="hapusMetodePembayaranModal" tabindex="-1" role="dialog" aria-labelledby="hapusMetodePembayaranModal" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Hapus Metode Pembayaran</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        Anda yakin ingin menghapus metode pembayaran ini ini?
                    </div>
    ...
    <script src="../dist/vendors/bootstrap4-toggle/js/bootstrap4-toggle.min.js"></script>

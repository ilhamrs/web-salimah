...
<body id="main-container" class="default">
    ...
    <main>
                ...
                <div class="col-12  align-self-center">
                    <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                        <div class="w-sm-100 mr-auto">
                            <h1>Edit Produk P001</h1>
                        </div>

                        <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                            <li class="breadcrumb-item"><a href="http://localhost/Salimah_CI/admin/dashboard">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="http://localhost/Salimah_CI/admin/list_produk">List Produk</a></li>
                ...
                <div class="col-12 mt-3">
                    <div class="card">
                        <div class="card-header  justify-content-between align-items-center">
                            <a type="button" class="btn btn-primary" href="http://localhost/Salimah_CI/admin/list_produk">Kembali</a>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <br><br>
                                            <button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#ubahFotoModal">Ubah Foto</button>
                                        </div>
                                    </div>
                                </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="ubahFotoModal" tabindex="-1" role="dialog" aria-labelledby="ubahFotoModal" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Upload Foto Baru Produk</h5>

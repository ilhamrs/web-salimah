                ...
                <div class="col-12  align-self-center">
                    <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                        <div class="w-sm-100 mr-auto">
                            <h1>Detail Pesanan 0001</h1>
                        </div>

                        <ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
                            <li class="breadcrumb-item"><a href="http://localhost/Salimah_CI/admin/dashboard">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="http://localhost/Salimah_CI/admin/list_pesanan">List Pesanan</a></li>
                                                ...
                                                <div class="float-right w-100 border p-3">
                                                    ...
                                                    <form>
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" id="no_resi" placeholder="ABC1234567890">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <div class="col-sm-10">
                                ...
                                <div class="col-lg-12 col-xl-5">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="row p-3">
                                            <div class="col-10">
                                                <div class="card-body">
                                                    <img src="../dist/images/shoes.jpg" alt="" class="img-fluid" width="600">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 col-sm-12 mt-3">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea disabled name="deskripsi" id="deskripsi" cols="80" rows="5" class="form-control">Barangnya bagus bet</textarea>
                                            </div>
